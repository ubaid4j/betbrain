...
public class OverUnderForThresholdDetection extends AbstractDAO
{
	...
	public OverUnderForThresholdDetection()
	{
	...
	public LinkedList<Entity> getAll(long id, int eventPartId, long providerId)
	{
		...
		{
			throw new RuntimeException("OverUnderForThreshold SQL Problem");
		}
	}
